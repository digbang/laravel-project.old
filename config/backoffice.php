...
return [
    'auth'   => [
        'login-route'         => App\Http\Routes\Backoffice\AuthRoutes::LOGIN,
    ...
    'menu'   => [
        'Backoffice' => [
            'Backoffice users' => [
                'icon'   => 'user',
                'route' => App\Http\Routes\Backoffice\UserRoutes::INDEX,
            ],
            'Backoffice roles' => [
                'icon'   => 'group',
                'route' => App\Http\Routes\Backoffice\RoleRoutes::INDEX,
            ],
        ],
    ],
];
