...
use Digbang\Security\Mappings\UserPermissionMappingHelper;

class BackofficeUserPermissionMapping implements EntityMapping
{
	/**
	...
	{
		(new UserPermissionMappingHelper())->addMappings($builder);
	}
